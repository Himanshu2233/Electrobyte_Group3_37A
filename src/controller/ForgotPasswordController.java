...
public class ForgotPasswordController {
    ...
    class ResetPasswordListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            String securityQuestion = forgotPasswordView.getSecurityQuestion();
            ...
            boolean updated = forgotDao.updatePasswordWithSecurityAnswer(username, email, securityQuestion, securityAnswer, newPassword);
            if (updated) {
